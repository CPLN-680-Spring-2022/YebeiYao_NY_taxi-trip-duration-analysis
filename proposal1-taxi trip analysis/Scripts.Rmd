...
# Random sample subset of trip data for exploratory data analysis, set seed to be reproduceable
set.seed(123)
...
#taxitrip_sample$pickup_month <- month(taxitrip_sample$pickup_datetime)
  ...
  taxitrip_sample <- taxitrip_sample%>%
    dplyr::select(-pickup_datetime,-dropoff_datetime)
  ...
  taxitrip_sample_parse$WeekDay <- weekdays(taxitrip_sample_parse$pickup_datetime.stamp)
